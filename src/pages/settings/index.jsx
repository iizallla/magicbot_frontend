    ...
    return <div>
        ...
        <div className="flex  gap-12">
            ...
            <div>
                ...
                <input className="border w-[300px] p-2 rounded-lg " type="time" />
            </div>
            <div>
        ...
        <div className="">
            <p className="font-medium ml-[15px] mt-[20px] mb-[20px]">Mahalliylashtirish sozlamalari</p>
            <Select>
        ...
        <p className="m-4 font-semibold">Manzil: Toshkent, Olmazor tumani, 2-to'siq Qorasaroy, 12</p>
        <div className="m-[14px]" style={{ position: 'relative', overflow: 'hidden' }}><iframe src="https://yandex.uz/map-widget/v1/?indoorLevel=1&ll=69.238124%2C41.318621&mode=whatshere&whatshere%5Bpoint%5D=69.233984%2C41.317799&whatshere%5Bzoom%5D=17&z=16.72source=constructor
